...
The Create React App's [very thorough documentation](https://github.com/facebookincubator/create-react-app/blob/master/packages/react-scripts/template/README.md) is considered **required reading** before contributing to this project.
